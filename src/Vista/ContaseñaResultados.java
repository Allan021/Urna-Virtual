 ...
 * @author Allan Crack
 */
public class ContaseñaResultados extends javax.swing.JDialog {

    /**
     * Creates new form Contaseña
     */
    public ContaseñaResultados(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
     setUndecorated(true);
        initComponents();
   ...
   return imagen;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ContaseñaResultados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ContaseñaResultados dialog = new ContaseñaResultados(new javax.swing.JFrame(), true);
